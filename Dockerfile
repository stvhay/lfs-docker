...
# COPY --chmod=744 sources/acl-2.3.2.tar.xz .
# COPY --chmod=744 sources/attr-2.5.2.tar.gz .
# COPY --chmod=744 sources/autoconf-2.72.tar.xz .
# COPY --chmod=744 sources/automake-1.18.1.tar.xz .
# COPY --chmod=744 sources/bash-5.3.tar.gz .
# COPY --chmod=744 sources/bc-7.0.3.tar.xz .
...
# COPY --chmod=744 sources/findutils-4.10.0.tar.xz .
# COPY --chmod=744 sources/flex-2.6.4.tar.gz .
# COPY --chmod=744 sources/gawk-5.3.2.tar.xz .
# COPY --chmod=744 sources/gcc-15.2.0.tar.xz .
# COPY --chmod=744 sources/gdbm-1.26.tar.gz .
# COPY --chmod=744 sources/gettext-1.0.tar.xz .
# COPY --chmod=744 sources/glibc-2.43.tar.xz .
# COPY --chmod=744 sources/gmp-6.3.0.tar.xz .
# COPY --chmod=744 sources/gperf-3.3.tar.gz .
# COPY --chmod=744 sources/grep-3.12.tar.xz .
# COPY --chmod=744 sources/groff-1.23.0.tar.gz .
...
# COPY --chmod=744 sources/libtool-2.5.4.tar.xz .
# COPY --chmod=744 sources/linux-6.18.10.tar.xz .
# COPY --chmod=744 sources/m4-1.4.21.tar.xz .
...
# COPY --chmod=744 sources/ncurses-6.6.tar.gz .
# COPY --chmod=744 sources/ninja-1.13.2.tar.gz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/gavinhoward/bc/releases/download/7.0.3/}bc-7.0.3.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/binutils/}binutils-2.46.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/bison/}bison-3.8.2.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://www.sourceware.org/pub/bzip2/}bzip2-1.0.8.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/coreutils/}coreutils-9.10.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://dbus.freedesktop.org/releases/dbus/}dbus-1.16.2.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/dejagnu/}dejagnu-1.6.3.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/diffutils/}diffutils-3.12.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://downloads.sourceforge.net/project/e2fsprogs/e2fsprogs/v1.47.3/}e2fsprogs-1.47.3.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://sourceware.org/ftp/elfutils/0.194/}elfutils-0.194.tar.bz2 .
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/libexpat/libexpat/releases/download/R_2_7_4/}expat-2.7.4.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://sourceforge.net/projects/expect/files/Expect/5.45.4/expect5.45.4.tar.gz/}download expect5.45.4.tar.gz
ADD --chmod=744 ${SOURCES_MIRROR:-https://astron.com/pub/file/}file-5.46.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/findutils/}findutils-4.10.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/westes/flex/releases/download/v2.6.4/}flex-2.6.4.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gawk/}gawk-5.3.2.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gcc/gcc-15.2.0/}gcc-15.2.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gdbm/}gdbm-1.26.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gettext/}gettext-1.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/glibc/}glibc-2.43.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gmp/}gmp-6.3.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gperf/}gperf-3.3.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/grep/}grep-3.12.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/groff/}groff-1.23.0.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/grub/}grub-2.14.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/gzip/}gzip-1.14.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/Mic92/iana-etc/releases/download/20260202/}iana-etc-20260202.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/inetutils/}inetutils-2.7.tar.gz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftpmirror.gnu.org/gnu/mpc/}mpc-1.3.1.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://www.mpfr.org/mpfr-4.2.2/}mpfr-4.2.2.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://invisible-mirror.net/archives/ncurses/}ncurses-6.6.tar.gz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://sourceforge.net/projects/procps-ng/files/Production/procps-ng-4.0.6.tar.xz/}download procps-ng-4.0.6.tar.xz
ADD --chmod=744 ${SOURCES_MIRROR:-https://sourceforge.net/projects/psmisc/files/psmisc/psmisc-23.7.tar.xz/}download psmisc-23.7.tar.xz
ADD --chmod=744 ${SOURCES_MIRROR:-https://www.python.org/ftp/python/3.14.3/}Python-3.14.3.tar.xz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://sqlite.org/2026/}sqlite-autoconf-3510200.tar.gz .
...
RUN --mount=type=tmpfs \
    ...
    --mount=from=sources,source=gmp-6.3.0.tar.xz,target=gmp-6.3.0.tar.xz \
    --mount=from=sources,source=mpc-1.3.1.tar.gz,target=mpc-1.3.1.tar.gz \
<<'EOT' $SH
...
# 6.4. Bash-5.1.16
RUN --mount=type=tmpfs \
    --mount=from=sources,source=bash-5.3.tar.gz,target=bash-5.3.tar.gz \
<<'EOT' $SH
...
# 6.7. File-5.41
RUN --mount=type=tmpfs \
    --mount=from=sources,source=file-5.46.tar.gz,target=file-5.46.tar.gz \
<<'EOT' $SH
...
# 6.8. Findutils-4.9.0
RUN --mount=type=tmpfs \
    --mount=from=sources,source=findutils-4.10.0.tar.xz,target=findutils-4.10.0.tar.xz \
<<'EOT' $SH
...
# 6.9. Gawk-5.1.1
RUN --mount=type=tmpfs \
    --mount=from=sources,source=gawk-5.3.2.tar.xz,target=gawk-5.3.2.tar.xz \
<<'EOT' $SH
...
# 6.10. Grep-3.7
RUN --mount=type=tmpfs \
    --mount=from=sources,source=grep-3.12.tar.xz,target=grep-3.12.tar.xz \
<<'EOT' $SH
...
# 6.11. Gzip-1.11
RUN --mount=type=tmpfs \
    --mount=from=sources,source=gzip-1.14.tar.xz,target=gzip-1.14.tar.xz \
<<'EOT' $SH
...
# 6.12. Make-4.3
RUN --mount=type=tmpfs \
    --mount=from=sources,source=make-4.4.1.tar.gz,target=make-4.4.1.tar.gz \
<<'EOT' $SH
...
# 6.13. Patch-2.7.6
RUN --mount=type=tmpfs \
    --mount=from=sources,source=patch-2.8.tar.xz,target=patch-2.8.tar.xz \
<<'EOT' $SH
...
# 6.14. Sed-4.8
RUN --mount=type=tmpfs \
    --mount=from=sources,source=sed-4.9.tar.xz,target=sed-4.9.tar.xz \
<<'EOT' $SH
...
# 6.15. Tar-1.34
RUN --mount=type=tmpfs \
    --mount=from=sources,source=tar-1.35.tar.xz,target=tar-1.35.tar.xz \
<<'EOT' $SH
...
# 6.16. Xz-5.2.5
RUN --mount=type=tmpfs \
    --mount=from=sources,source=xz-5.8.2.tar.xz,target=xz-5.8.2.tar.xz \
<<'EOT' $SH
...
# 7.12. Texinfo-6.8
RUN --mount=type=tmpfs \
    --mount=from=sources,source=texinfo-7.2.tar.xz,target=texinfo-7.2.tar.xz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=util-linux-2.41.3.tar.xz,target=util-linux-2.41.3.tar.xz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=iana-etc-20260202.tar.gz,target=iana-etc-20260202.tar.gz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=tzdata2025c.tar.gz,target=tzdata2025c.tar.gz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=zlib-1.3.2.tar.xz,target=zlib-1.3.2.tar.xz \
<<'EOT' $SH
...
# 8.11. Readline-8.1.2
RUN --mount=type=tmpfs \
    --mount=from=sources,source=readline-8.3.tar.gz,target=readline-8.3.tar.gz \
<<'EOT' $SH
...
# 8.15. Tcl-8.6.12
RUN --mount=type=tmpfs \
    --mount=from=sources,source=tcl8.6.17-src.tar.gz,target=tcl8.6.17-src.tar.gz \
    --mount=from=sources,source=tcl8.6.17-html.tar.gz,target=tcl8.6.17-html.tar.gz \
<<'EOT' $SH
...
# 8.22. Attr-2.5.1
RUN --mount=type=tmpfs \
    --mount=from=sources,source=attr-2.5.2.tar.gz,target=attr-2.5.2.tar.gz \
<<'EOT' $SH
...
# 8.23. Acl-2.3.1
RUN --mount=type=tmpfs \
    --mount=from=sources,source=acl-2.3.2.tar.xz,target=acl-2.3.2.tar.xz \
<<'EOT' $SH
...
# 8.24. Libcap-2.63
RUN --mount=type=tmpfs \
    --mount=from=sources,source=libcap-2.77.tar.xz,target=libcap-2.77.tar.xz \
<<'EOT' $SH
...
# 8.30. Psmisc-23.4
RUN --mount=type=tmpfs \
    --mount=from=sources,source=psmisc-23.7.tar.xz,target=psmisc-23.7.tar.xz \
<<'EOT' $SH
...
# 8.35. Libtool-2.4.6
RUN --mount=type=tmpfs \
    --mount=from=sources,source=libtool-2.5.4.tar.xz,target=libtool-2.5.4.tar.xz \
<<'EOT' $SH
...
# 8.36. GDBM-1.23
RUN --mount=type=tmpfs \
    --mount=from=sources,source=gdbm-1.26.tar.gz,target=gdbm-1.26.tar.gz \
<<'EOT' $SH
...
# 8.37. Gperf-3.1
RUN --mount=type=tmpfs \
    --mount=from=sources,source=gperf-3.3.tar.gz,target=gperf-3.3.tar.gz \
<<'EOT' $SH
...
# 8.38. Expat-2.4.6
RUN --mount=type=tmpfs \
    --mount=from=sources,source=expat-2.7.4.tar.xz,target=expat-2.7.4.tar.xz \
<<'EOT' $SH
...
# 8.40. Less-590
RUN --mount=type=tmpfs \
    --mount=from=sources,source=less-692.tar.gz,target=less-692.tar.gz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=XML-Parser-2.47.tar.gz,target=XML-Parser-2.47.tar.gz \
<<'EOT' $SH
...
# 8.44. Autoconf-2.71
RUN --mount=type=tmpfs \
    --mount=from=sources,source=autoconf-2.72.tar.xz,target=autoconf-2.72.tar.xz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=automake-1.18.1.tar.xz,target=automake-1.18.1.tar.xz \
<<'EOT' $SH
...
# 8.46. OpenSSL-3.0.1
RUN --mount=type=tmpfs \
    --mount=from=sources,source=openssl-3.6.1.tar.gz,target=openssl-3.6.1.tar.gz \
<<'EOT' $SH
...
# 8.49. Libffi-3.4.2
RUN --mount=type=tmpfs \
    --mount=from=sources,source=libffi-3.5.2.tar.gz,target=libffi-3.5.2.tar.gz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=ninja-1.13.2.tar.gz,target=ninja-1.13.2.tar.gz \
<<'EOT' $SH
...
# 8.58. Groff-1.22.4
RUN --mount=type=tmpfs \
    --mount=from=sources,source=groff-1.23.0.tar.gz,target=groff-1.23.0.tar.gz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=iproute2-6.18.0.tar.xz,target=iproute2-6.18.0.tar.xz \
<<'EOT' $SH
...
# 8.62. Kbd-2.4.0
RUN --mount=type=tmpfs \
    --mount=from=sources,source=kbd-2.9.0.tar.xz,target=kbd-2.9.0.tar.xz \
    --mount=from=sources,source=kbd-2.9.0-backspace-1.patch,target=kbd-2.9.0-backspace-1.patch \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=libpipeline-1.5.8.tar.gz,target=libpipeline-1.5.8.tar.gz \
<<'EOT' $SH
...
# 8.68. Vim-8.2.4383
RUN --mount=type=tmpfs \
    --mount=from=sources,source=vim-9.2.0078.tar.gz,target=vim-9.2.0078.tar.gz \
<<'EOT' $SH
    ...
    ln -sv ../vim/vim82/doc /usr/share/doc/vim-9.2.0078
EOT
...
# 8.73. Man-DB-2.10.1
RUN --mount=type=tmpfs \
    --mount=from=sources,source=man-db-2.13.1.tar.xz,target=man-db-2.13.1.tar.xz \
<<'EOT' $SH
...
RUN --mount=type=tmpfs \
    --mount=from=sources,source=e2fsprogs-1.47.3.tar.gz,target=e2fsprogs-1.47.3.tar.gz \
<<'EOT' $SH
