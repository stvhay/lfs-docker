...
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/autoconf/}autoconf-2.72.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/automake/}automake-1.18.1.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/bash/}bash-5.3.tar.gz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/findutils/}findutils-4.10.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/westes/flex/releases/download/v2.6.4/}flex-2.6.4.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/gawk/}gawk-5.3.2.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/gcc/gcc-15.2.0/}gcc-15.2.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/gdbm/}gdbm-1.26.tar.gz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/gmp/}gmp-6.3.0.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/gperf/}gperf-3.3.tar.gz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/grep/}grep-3.12.tar.xz .
ADD --chmod=744 ${SOURCES_MIRROR:-https://ftp.gnu.org/gnu/groff/}groff-1.23.0.tar.gz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/Mic92/iana-etc/releases/download/20220207/}iana-etc-20260202.tar.gz .
