...
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/gavinhoward/bc/releases/download/5.2.2/}bc-7.0.3.tar.xz .
...
ADD --chmod=744 ${SOURCES_MIRROR:-https://github.com/ninja-build/ninja/archive/v1.10.2/}ninja-1.13.2.tar.gz .
